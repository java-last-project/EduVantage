...
public class BookRestController {
	...
	public ResponseEntity<Map> book_list(@RequestParam(value = "page", defaultValue = "1") int page,
	...
	public Map<String, Object> bookFindData(@RequestParam(value = "keyword", defaultValue = "") String keyword,
	...
	public Map<String, Object> bookLikeStatus(@RequestParam("book_no") int bookNo, HttpSession session) {
	...
	public Map<String, Object> bookLikeToggle(@RequestParam("book_no") int bookNo, HttpSession session) {
	...
	public Map<String, Object> commentListVue(@RequestParam("fno") int fno,
			@RequestParam(value = "page", defaultValue = "1") int page) {
